...
function getCookie(name) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const addButton = document.getElementById('stock');
    if(addButton)
    {
      const wrapper = document.querySelector(".wrapper");
      const tableP = document.querySelector(".nodata");
  
      // Add event listener to the "Add your first material" button
      addButton.addEventListener("click", function () {
        ...
        headerRow.classList.add("row", "header", "green");
        const headerCells = ["Product", "Unit Price", "Quantity", "Edit"];
        ...
        // Remove the paragraph with class 'table_p'
        tableP.remove();
        ...
        newButton.setAttribute("id", "update-stock-btn");
        newButton.setAttribute("class", "button-1");
